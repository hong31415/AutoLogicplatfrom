(() => {
  ...
  const exact = new Map(Object.entries({
    ...
    "查看离线写作图": "View Offline Writing Graph",
    "我的写作图": "My Writing Graph",
    ...
    "重新诱导写作图": "Re-induce Writing Graph",
    "忽略本地写作图缓存": "Ignore Local Writing-Graph Cache",
    ...
    "全局写作图": "Global Writing Graph",
    "对话解析": "Query Parsing",
    "状态匹配": "State Matching",
    "查询执行图": "Query-Specific Execution Graph",
    "数据证据": "Data Evidence",
    "数据与证据": "Data & Evidence",
    ...
    "系统写作图": "System Writing Graph",
    "我的写作图 · 宏观研究 · 自定义写作图": "My Writing Graph · Macro Research · Custom Writing Graph",
    ...
    "选择生成报告使用的写作图": "Choose the writing graph used to generate the report",
    "设置写作图信息范围": "Configure Writing-Graph Information Scope",
    "本次生成使用的写作图": "Writing Graph Used for This Run",
    "写作图来源": "Writing-Graph Source",
    "系统写作图 · 按垂类自动选择": "System Writing Graph · Auto-select by domain",
    "管理 / 构建我的写作图": "Manage / Build My Writing Graph",
    "手动构建 / 编辑": "Build / Edit Manually",
    "上传模板自动构建": "Build from Uploaded Templates",
    "写作图信息范围": "Writing-Graph Information Scope",
    "频率阈值 θ": "Frequency Threshold θ",
    "匹配阈值 τ": "Match Threshold τ",
    "关闭": "Close",
    "离线全局写作图": "Offline Global Writing Graph",
    "读取本地已诱导的写作结构。": "Load the locally induced writing structure.",
    "报告领域": "Report Domain",
    "切换结构": "Switch Structure",
    "写作图显示控制": "Writing Graph View Controls",
    "缩小写作图": "Zoom Out Writing Graph",
    "放大写作图": "Zoom In Writing Graph",
    "适应窗口": "Fit to Window",
    "放大画布": "Expand Canvas",
    "我的垂类结构": "My Domain Structures",
    "导入系统垂类": "Import a System Domain",
    "导入为我的写作图": "Import as My Writing Graph",
    "导入创建独立副本，不修改系统训练模板。": "Importing creates an independent copy and does not modify the system template.",
    "还没有用户写作图": "No User Writing Graph Yet",
    "从左侧选择一个系统垂类导入，即可开始构建自己的段落状态机。": "Import a system domain from the left to start building your own paragraph state machine.",
    "写作图名称": "Writing-Graph Name",
    "＋ 添加段落": "+ Add Section",
    "保存结构": "Save Structure",
    "删除": "Delete",
    "基础垂类": "Base Domain",
    ...
    "添加转移": "Add Transition",
    "关闭我的写作图": "Close My Writing Graph",
    "用户写作图保存在当前浏览器本机存储中；系统原始写作图始终保持只读并可重新导入。": "User writing graphs are stored locally in this browser. Original system graphs remain read-only and can always be re-imported.",
    "上传模板自动构建写作图": "Build a Writing Graph from Templates",
    ...
    "怎样获得更稳定的写作图？": "How to Build a More Stable Graph",
    "开始构建 DFA": "Start Building DFA",
    "模板写作图库": "Template Writing-Graph Library",
    "全部领域": "All Domains",
    "搜索": "Search",
    "刷新": "Refresh",
    "构建完成的写作图会按领域和分类保存在这里。": "Completed writing graphs are saved here by domain and category.",
    "文件解析": "File Parsing",
    ...
    "查询执行图与执行轨迹": "Query-Specific Execution Graph & Trace",
    "动态构建": "Dynamic Construction",
    "放大查看查询执行图": "Expand Query-Specific Execution Graph",
    "等待查询执行图构建": "Waiting for Query-Specific Execution Graph",
    "当前构建对象": "Current Construction Target",
    "初始化全局写作图": "Initialize Global Writing Graph",
    "构建依据": "Construction Basis",
    "当前产出": "Current Output",
    "等待解析用户对话": "Waiting to Parse the User Request",
    "等待构建本次查询执行图": "Waiting to Build This Query-Specific Execution Graph",
    ...
    "等待执行": "Waiting",
    "已完成": "Complete",
    "读取我的写作图": "Load My Writing Graph",
    "读取系统全局写作图": "Load System Global Writing Graph",
    ...
    "本次查询执行图构建完成": "Query-Specific Execution Graph Ready",
    "本次查询执行图已构建完成": "Query-Specific Execution Graph Ready",
    "查询执行图构建过程": "Query-Specific Execution Graph Construction",
    ...
    ,"宏观研究": "Macro Research"
    ,"宏观研究 · 自定义写作图": "Macro Research · Custom Writing Graph"
    ,"自定义写作图": "Custom Writing Graph"
    ...
    ,"正在载入离线全局写作图": "Loading the offline global writing graph"
    ...
    ,"等待条件标注写作图": "Waiting to annotate writing-graph conditions"
    ...
    ,"该图来自本机缓存的全局写作图；本窗口不会调用市场数据或生成报告。": "This graph comes from the locally cached global writing graph. This window does not call market-data services or generate a report."
    ,"离线全局写作图": "Offline Global Writing Graph"
  }));

  const replacements = [
    ["正在根据全局写作图与当前对话构建查询执行图。", "Building a query-specific execution graph from the global writing graph and the current query."],
    ...
    ["系统结构或你保存的自定义结构，将用于构建本次查询执行图。", "Choose a system structure or a saved custom structure for this query-specific execution graph."],
    ["当前将使用系统训练得到的全局写作图。", "The system-trained global writing graph will be used."],
    ["本次将使用", "This run will use "],
    ["构建查询执行图", "to build the query-specific execution graph"],
